...
const SchoolCard = () => {
  return (
    <div className='md:relative'>
      <Image className='w-[750px] md:h-[500px] object-cover' src={school} alt='drive' />
      <div className='p-6 py-12 md:absolute md:top-16 md:right-5 w-full md:w-[600px] h-auto bg-[#8F81EA] text-black'>
